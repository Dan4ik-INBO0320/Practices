...
public class Test {
    public static void main(String[] args) {
        ...
        //System.out.println(s3.getLength()); // Попытка вызова объектом класса Shape метода класса Rectangle. Ошибка
        ...
        Shape s4 = new Square(6.6); // Upcast. Переопределение объекта класса Square в класс Shape
        System.out.println(s4);
        System.out.println(s4.getArea());
        System.out.println(s4.getColor());
        //System.out.println(s4.getSide()); // Попытка вызова метода класса Square объектом класса Shape. Ошибка
...
// which is a superclass of Square, instead of Square
        ...
        //System.out.println(r2.getSide()); // Попытка вызова метода класса Square объектом класса Rectangle. Ошибка
